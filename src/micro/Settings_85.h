#ifndef TRF_85_SETTINGS_H
#define TRF_85_SETTINGS_H
 ...
 * If you need custom speeds you can define one for yourself in the header file "TinyRF_85.h"
 *
 * Preabmle:
